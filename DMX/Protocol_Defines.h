...
#define PING_CMD_LENGTH				9				// length of a ping command
#define HEADER_LENGTH				8				// standard header length (everything up to and including COMMAND)
#define STANDARD_LENGTH				HEADER_LENGTH+1	// standard length of entire command (header+checksum)
#define STD_LEN_CMD				(char) STANDARD_LENGTH-ADD_TO_GET_LENGTH		// length field for standard command
#define NUM_OF_COORDS				3								// localization parameters
#define JUST_XY					(int) NUM_OF_COORDS-1			// localization parameters
	
// DEVICE INFO:

// arduino 0
#define ARD_0_ID				(unsigned char) 0xD0
#define ARD_0_IP				"128.197.164.68"            
#define ARD_0_PORT				"1"			
// arduino 1
#define ARD_1_ID				(unsigned char) 0xD1
#define ARD_1_IP				"128.197.164.68"			
#define ARD_1_PORT				"2"							
